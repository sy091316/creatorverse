            ...
            <div className="app" style={divapp}>
                ...
                <main style={{ backgroundColor: "black" }}>
                    {allData.map((item, idx) =>
                        <>
                            <div className="container" key={item.id} style={{ paddingTop: '40px' }}>
                                <div className="container-row" key={idx} style={{ display: 'flex', justifyContent: 'center', marginBottom: '20px' }}>
                                    <div className="container-column-img" key={idx} style={{ margin: '30px', border: '2px solid rgb(67, 115, 157)', borderRadius: '3px' }}>
                                ...
                                <div className="section_modal" key={item.id} style={{ display: open ? 'inline-block' : 'none' }}>
                                    <div className="modal" style={modal}>
                                        <div className="modal-content" style={modalContent}>
                                            ...
                                            <p style={{ color: 'white', fontSize: '3vh' }}>Are you sure you want to delete {item.name}???</p>
